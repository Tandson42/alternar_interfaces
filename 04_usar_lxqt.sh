...
# ==============================================================================
# FORÇAR LXQt + SDDM
# Execute como: sudo bash 04_usar_lxqt.sh
# ==============================================================================
set -euo pipefail
...
command -v lxqt-session &>/dev/null || die "$DE não instalado. Execute: sudo bash 00_instalar_tudo.sh"

# --- Verificar sessão .desktop ---
SESSION_DESKTOP=$(find /usr/share/xsessions/ -iname "lxqt*.desktop" 2>/dev/null | head -1)
if [[ -z "$SESSION_DESKTOP" ]]; then
    warn "Sessão 'lxqt' não encontrada em /usr/share/xsessions/"
