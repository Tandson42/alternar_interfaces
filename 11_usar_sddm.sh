#!/usr/bin/env bash
# ==============================================================================
# FORÇAR SDDM (só DM) + SDDM
# Execute como: sudo bash 11_usar_sddm.sh
# ==============================================================================
set -euo pipefail
...
DE="SDDM (só DM)"; DM="sddm"; SESSION="plasma"
...
command -v sddm &>/dev/null || die "$DE não instalado. Execute: sudo bash 00_instalar_tudo.sh"
