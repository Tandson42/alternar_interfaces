#!/usr/bin/env bash
# ==============================================================================
# FORÇAR Budgie + LIGHTDM
# Execute como: sudo bash 07_usar_budgie.sh
# ==============================================================================
set -euo pipefail
...
DE="Budgie"; DM="lightdm"; SESSION="budgie-desktop"
...
command -v budgie-panel &>/dev/null || die "$DE não instalado. Execute: sudo bash 00_instalar_tudo.sh"

# --- Verificar sessão .desktop ---
SESSION_DESKTOP=$(find /usr/share/xsessions/ -iname "budgie-desktop*.desktop" 2>/dev/null | head -1)
if [[ -z "$SESSION_DESKTOP" ]]; then
    warn "Sessão 'budgie-desktop' não encontrada em /usr/share/xsessions/"
