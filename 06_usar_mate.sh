...
# ==============================================================================
# FORÇAR MATE + LIGHTDM
# Execute como: sudo bash 06_usar_mate.sh
# ==============================================================================
set -euo pipefail
...
DE="MATE"; DM="lightdm"; SESSION="mate"
...
command -v mate-session &>/dev/null || die "$DE não instalado. Execute: sudo bash 00_instalar_tudo.sh"

# --- Verificar sessão .desktop ---
SESSION_DESKTOP=$(find /usr/share/xsessions/ -iname "mate*.desktop" 2>/dev/null | head -1)
if [[ -z "$SESSION_DESKTOP" ]]; then
    warn "Sessão 'mate' não encontrada em /usr/share/xsessions/"
