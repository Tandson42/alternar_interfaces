#!/usr/bin/env bash
# ==============================================================================
# FORÇAR GDM3 (só DM) + GDM3
# Execute como: sudo bash 09_usar_gdm.sh
# ==============================================================================
set -euo pipefail
...
DE="GDM3 (só DM)"; DM="gdm3"; SESSION="gnome"
...
command -v gdm3 &>/dev/null || die "$DE não instalado. Execute: sudo bash 00_instalar_tudo.sh"
