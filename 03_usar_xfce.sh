...
# ==============================================================================
# FORÇAR XFCE + LIGHTDM
# Execute como: sudo bash 03_usar_xfce.sh
# ==============================================================================
set -euo pipefail
...
DE="XFCE"; DM="lightdm"; SESSION="xfce"
...
command -v xfce4-session &>/dev/null || die "$DE não instalado. Execute: sudo bash 00_instalar_tudo.sh"
